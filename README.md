...
For step-by-step **installation** instructions, please refer to the [Installation Guide](Text%20Mining/LLM%20Hermeneutic%20Workbench/UseInstruction/README.md).


To get **started** with example data, check out the [Example Usage Guide](Text%20Mining/LLM%20Hermeneutic%20Workbench/Examples/README.md).
